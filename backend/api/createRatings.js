...
router.post("/", async (req, res) => {
  try {
    ...
    // Logic for seeing if a user already rated a course
    ...
    const alreadyRatedCourse = existingUser.Rated_Courses.some(
      (ratedCourseId) => ratedCourseId.toString() === Course.toString(),
    );
